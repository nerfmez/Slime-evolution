...
try{
 ...
 // Use real gameplay clocks and collision; limit other activity only in this QA page.
 ...
 // Both normal and Alpha are the Water slot; all other canonical elites remain unchanged.
