...
try{
 ...
 await page.waitForFunction(()=>document.querySelector('#error').hidden===false||(__slimeGameQA?.sparkRenderer&&document.querySelector('.skill-card')),null,{timeout:60000});
 ...
 await page.waitForFunction(()=>__slimeGameQA.world.enemies.length>0);
...
}catch(e){report={...report,error:e.stack,errors};console.error(report);process.exitCode=1;}
