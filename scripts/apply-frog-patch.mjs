...
if(!alreadyPatched){
 ...
 // Replace only the normal Thorn 2D renderer. Elite Thorn continues down the authored 3D path.
 ...
 console.log('Authoritative Moss Frog runtime already materialized; keeping it unchanged.');
}
...
console.log(alreadyPatched?'Verified materialized Moss Frog authoritative release.':'Applied safe Moss Frog runtime patch to authoritative published release.');
