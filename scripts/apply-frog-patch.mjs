...
console.log(hasDirectionalFacing?'Verified directional Moss Frog authoritative release.':'Applied directional Moss Frog renderer to authoritative published release.');
