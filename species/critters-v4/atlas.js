...
export const SPECIES_EXP_FRAMES=Object.freeze({
  thorn:Object.freeze(['low_frog_f','low_frog_b']),
  spark:Object.freeze(['mid_hedgehog_f','mid_hedgehog_b']),
  turtle:Object.freeze(['high_turtle_f','high_turtle_b']),
  panda:Object.freeze(['high_panda_f','high_panda_b']),
  water:Object.freeze(['water_elephant_f','water_elephant_b'])
});
export const PANDA_ROLL='panda_roll3';
export const ITEM_FRAMES=Object.freeze({magnet:Object.freeze(['magnet_f','magnet_b']),nova:Object.freeze(['nova_f','nova_b']),heal:Object.freeze(['heal_f','heal_b'])});
